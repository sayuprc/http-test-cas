...
class TestResponse
{
     ...
     * @return static
     */
    public function assertNotStatusCode(int $expected): TestResponse
    {
     ...
     * @return static
     */
    public function assertNotHeader(string $name, array $expected): TestResponse
    {
     ...
     * @return static
     */
    public function assertNotHeaderLine(string $name, string $expected): TestResponse
    {
     ...
     * @return static
     */
    public function assertNotLocation(string $expected): TestResponse
    {
     ...
     * @return static
     */
    public function assertNotContentType(string $expected): TestResponse
    {
     ...
     * @return static
     */
    public function assertNotBody(string $expected): TestResponse
    {
     ...
     * @return static
     */
    public function assertNotBodyContains(string $needle): TestResponse
    {
     ...
     * @return static
     */
    public function assertNotJson($expected): TestResponse
    {
        if (is_string($expected)) {
            $expected = json_decode($expected, true);
        }
     ...
     * @return static
     */
    public function assertNotJsonKey(string $key, $expected): TestResponse
    {
        $jsonArray = json_decode($this->getBody(), true);
